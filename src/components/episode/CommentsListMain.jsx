...
const CommentsListMain = ({ view, id }) => {
  // // const commentsInfo = [
  // //   {
  // //     name: "유진",
  // //     id: "haneugene",
  ...
  // let commentsInfo;
  // let bestCommentsInfo;
  const commentsInfo = useEffect(async () => {
    return await getComments(id);
  }, []);

  const bestCommentsInfo = useEffect(async () => {
    return await getBestComments(id);
  }, []);
